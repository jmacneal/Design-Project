-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_modulator/wave_generator.vhd
...
-- sfix16 [512]
  CONSTANT nc_2                           : vector_of_signed16(0 TO 511) := 
    (to_signed(16#0000#, 16), to_signed(16#0032#, 16), to_signed(16#0065#, 16), to_signed(16#0097#, 16), 
      to_signed(16#00C9#, 16), to_signed(16#00FC#, 16), to_signed(16#012E#, 16), to_signed(16#0161#, 16), 
      to_signed(16#0193#, 16), to_signed(16#01C5#, 16), to_signed(16#01F8#, 16), to_signed(16#022A#, 16), 
      to_signed(16#025C#, 16), to_signed(16#028F#, 16), to_signed(16#02C1#, 16), to_signed(16#02F3#, 16), 
...
-- sfix16 [512]
  ...
  SIGNAL insig_out1_1                     : unsigned(8 DOWNTO 0);  -- ufix9_En9
  SIGNAL Point25_out1_1                   : unsigned(15 DOWNTO 0);  -- ufix16_En16
  SIGNAL LTEp25_1_cast_1                  : unsigned(15 DOWNTO 0);  -- ufix16_En16
  ...
  SIGNAL LTEp50_1_cast_1                  : unsigned(15 DOWNTO 0);  -- ufix16_En16
  ...
  SIGNAL QuadHandle2_out1_1               : unsigned(8 DOWNTO 0);  -- ufix9_En9
  SIGNAL CastU16En1_out1                  : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL CastU16En3_out1_1                : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL x4_out1_1                        : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL CastU16En2_out1_1                : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL Switch_out1_1                    : unsigned(8 DOWNTO 0);  -- ufix9
...
BEGIN
  ...
  x_x <= std_logic_vector(Sine_2);

  insig_out1_1 <= unsigned(u_signed(13 DOWNTO 5));
  ...
  p75mA_sub_cast_1 <= signed(resize(insig_out1_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0', 17));
  ...
  p25mA_sub_cast_1 <= signed(resize(insig_out1_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0', 17));
  ...
  QuadHandle1b_out1_dtc <= "111111111" WHEN (QuadHandle1b_out1(16) = '0') AND (QuadHandle1b_out1(15 DOWNTO 7) 
    = "111111111") ELSE
  ...
  QuadHandle1a_out1_dtc <= "111111111" WHEN (QuadHandle1a_out1(16) = '0') AND (QuadHandle1a_out1(15 DOWNTO 7) 
    = "111111111") ELSE
  ...
  CastU16En3_out1_1 <= resize(CastU16En1_out1, 10);

  -- equivalent to multiply
  -- by 4 with saturation
  x4_out1_1 <= CastU16En3_out1_1 sll 2;

  -- saturation block maybe optimized away
  -- if the NumDataPoints is a power of 2
  
  CastU16En2_out1_1 <= "111111111" WHEN x4_out1_1(9) /= '0' ELSE
      x4_out1_1(8 DOWNTO 0);
  ...
  Look_Up_Table_k_1 <= to_unsigned(16#000#, 9) WHEN Switch_out1_1 = to_unsigned(16#000#, 9) ELSE
      to_unsigned(16#1FF#, 9) WHEN Switch_out1_1 = to_unsigned(16#1FF#, 9) ELSE
      Switch_out1_1;
