-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_modulator/imag_carrier_wave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: imag_carrier_wave
-- Source Path: hdl_modulator/imag_carrier_wave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY imag_carrier_wave IS
  PORT( u_u                               :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En15
        x_x                               :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END imag_carrier_wave;


ARCHITECTURE rtl OF imag_carrier_wave IS
...
-- sfix16 [512]
  ...
  -- Signals
  SIGNAL u_signed                         : signed(17 DOWNTO 0);  -- sfix18_En15
...
BEGIN
  ...
  insig_out1 <= unsigned(u_signed(14 DOWNTO 6));
