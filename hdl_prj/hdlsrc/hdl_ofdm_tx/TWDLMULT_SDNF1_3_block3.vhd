-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/TWDLMULT_SDNF1_3_block3.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block3 IS
  ...
  -- Signals
  SIGNAL dout_9_re_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout_9_im_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout_11_re_signed                : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout_11_im_signed                : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL twdlXdin_10_re_tmp               : std_logic_vector(18 DOWNTO 0);  -- ufix19
  SIGNAL twdlXdin_10_im_tmp               : std_logic_vector(18 DOWNTO 0);  -- ufix19
...
BEGIN
  u_MUL3_2 : Complex3Multiply_block5
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_10_re => twdlXdin_10_re_tmp,  -- sfix19_En13
              twdlXdin_10_im => twdlXdin_10_im_tmp,  -- sfix19_En13
              twdlXdin2_vld => twdlXdin_9_vld
              );

  dout_9_re_signed <= signed(dout_9_re);

  din_re <= resize(dout_9_re_signed, 19);
  ...
  din_im <= resize(dout_9_im_signed, 19);
  ...
  din_re_1 <= resize(dout_11_re_signed, 19);
  ...
  din_im_1 <= resize(dout_11_im_signed, 19);
