-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/RADIX22FFT_SDNF1_1_block4.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block4 IS
  ...
  -- Signals
  SIGNAL twdlXdin_11_re_signed            : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL twdlXdin_11_im_signed            : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL twdlXdin_12_re_signed            : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL twdlXdin_12_im_signed            : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL dout_11_re_tmp                   : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dout_11_im_tmp                   : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dout_12_re_tmp                   : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL dout_12_im_tmp                   : signed(16 DOWNTO 0);  -- sfix17_En13
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_re_reg, Radix22ButterflyG1_NF_btf1_im_reg,
       ...
       Radix22ButterflyG1_NF_dinXtwdl_vld_dly1, twdlXdin_11_re_signed,
       twdlXdin_11_im_signed, twdlXdin_12_re_signed, twdlXdin_12_im_signed,
       twdlXdin_1_vld)
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      add_cast := resize(twdlXdin_11_re_signed, 18);
      add_cast_0 := resize(twdlXdin_12_re_signed, 18);
      Radix22ButterflyG1_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(twdlXdin_11_re_signed, 18);
      sub_cast_0 := resize(twdlXdin_12_re_signed, 18);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_1 := resize(twdlXdin_11_im_signed, 18);
      add_cast_2 := resize(twdlXdin_12_im_signed, 18);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(twdlXdin_11_im_signed, 18);
      sub_cast_2 := resize(twdlXdin_12_im_signed, 18);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= sub_cast_1 - sub_cast_2;
    END IF;
    dout_11_re_tmp <= Radix22ButterflyG1_NF_btf1_re_reg(16 DOWNTO 0);
    dout_11_im_tmp <= Radix22ButterflyG1_NF_btf1_im_reg(16 DOWNTO 0);
    dout_12_re_tmp <= Radix22ButterflyG1_NF_btf2_re_reg(16 DOWNTO 0);
    dout_12_im_tmp <= Radix22ButterflyG1_NF_btf2_im_reg(16 DOWNTO 0);
