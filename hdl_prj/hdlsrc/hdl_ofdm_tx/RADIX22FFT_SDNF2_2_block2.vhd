-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/RADIX22FFT_SDNF2_2_block2.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block2 IS
  ...
  -- Signals
  SIGNAL dout_6_re_signed                 : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL din1_re                          : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_6_im_signed                 : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL din1_im                          : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_8_re_signed                 : signed(16 DOWNTO 0);  -- sfix17_En13
  SIGNAL din2_re                          : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_8_im_signed                 : signed(16 DOWNTO 0);  -- sfix17_En13
  ...
  SIGNAL dout_7_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_7_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_8_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dout_8_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En13

BEGIN
  dout_6_re_signed <= signed(dout_6_re);

  din1_re <= resize(dout_6_re_signed, 18);

  dout_6_im_signed <= signed(dout_6_im);

  din1_im <= resize(dout_6_im_signed, 18);

  dout_8_re_signed <= signed(dout_8_re);

  din2_re <= resize(dout_8_re_signed, 18);

  dout_8_im_signed <= signed(dout_8_im);

  din2_im <= resize(dout_8_im_signed, 18);
  ...
  BEGIN
    ...
    END IF;
    dout_7_re_tmp <= Radix22ButterflyG2_NF_btf1_re_reg(17 DOWNTO 0);
    dout_7_im_tmp <= Radix22ButterflyG2_NF_btf1_im_reg(17 DOWNTO 0);
    dout_8_re_tmp <= Radix22ButterflyG2_NF_btf2_re_reg(17 DOWNTO 0);
    dout_8_im_tmp <= Radix22ButterflyG2_NF_btf2_im_reg(17 DOWNTO 0);
