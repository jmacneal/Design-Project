-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/RADIX22FFT_SDNF2_4_block4.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block4 IS
  ...
  -- Signals
  SIGNAL dout_4_re_signed                 : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din1_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_4_im_signed                 : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din1_im                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_12_re_signed                : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din2_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_12_im_signed                : signed(18 DOWNTO 0);  -- sfix19_En13
  ...
  SIGNAL dout_11_re_tmp                   : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_11_im_tmp                   : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_12_re_tmp                   : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_12_im_tmp                   : signed(19 DOWNTO 0);  -- sfix20_En13

BEGIN
  dout_4_re_signed <= signed(dout_4_re);

  din1_re <= resize(dout_4_re_signed, 20);

  dout_4_im_signed <= signed(dout_4_im);

  din1_im <= resize(dout_4_im_signed, 20);

  dout_12_re_signed <= signed(dout_12_re);

  din2_re <= resize(dout_12_re_signed, 20);

  dout_12_im_signed <= signed(dout_12_im);

  din2_im <= resize(dout_12_im_signed, 20);
  ...
  BEGIN
    ...
    END IF;
    dout_11_re_tmp <= Radix22ButterflyG2_NF_btf1_re_reg(19 DOWNTO 0);
    dout_11_im_tmp <= Radix22ButterflyG2_NF_btf1_im_reg(19 DOWNTO 0);
    dout_12_re_tmp <= Radix22ButterflyG2_NF_btf2_re_reg(19 DOWNTO 0);
    dout_12_im_tmp <= Radix22ButterflyG2_NF_btf2_im_reg(19 DOWNTO 0);
