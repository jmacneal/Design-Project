-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/TWDLMULT_SDNF1_3.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3 IS
  ...
  -- Signals
  SIGNAL dout_1_re_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout_1_im_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout_3_re_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL dout_3_im_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL twdlXdin_2_re_tmp                : std_logic_vector(18 DOWNTO 0);  -- ufix19
  SIGNAL twdlXdin_2_im_tmp                : std_logic_vector(18 DOWNTO 0);  -- ufix19
...
BEGIN
  u_MUL3_2 : Complex3Multiply
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_2_re => twdlXdin_2_re_tmp,  -- sfix19_En13
              twdlXdin_2_im => twdlXdin_2_im_tmp,  -- sfix19_En13
              twdlXdin2_vld => twdlXdin_1_vld
              );

  dout_1_re_signed <= signed(dout_1_re);

  din_re <= resize(dout_1_re_signed, 19);
  ...
  din_im <= resize(dout_1_im_signed, 19);
  ...
  din_re_1 <= resize(dout_3_re_signed, 19);
  ...
  din_im_1 <= resize(dout_3_im_signed, 19);
