-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/RADIX22FFT_SDNF1_3_block4.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_3_block4 IS
  ...
  -- Signals
  SIGNAL twdlXdin_10_re_signed            : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL twdlXdin_10_im_signed            : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL twdlXdin_14_re_signed            : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL twdlXdin_14_im_signed            : signed(18 DOWNTO 0);  -- sfix19_En13
  ...
  SIGNAL dout_11_re_tmp                   : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL dout_11_im_tmp                   : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL dout_12_re_tmp                   : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL dout_12_im_tmp                   : signed(18 DOWNTO 0);  -- sfix19_En13
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_re_reg, Radix22ButterflyG1_NF_btf1_im_reg,
       ...
       twdlXdin_10_im_signed, twdlXdin_14_re_signed, twdlXdin_14_im_signed,
       twdlXdin_1_vld)
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      add_cast := resize(twdlXdin_10_re_signed, 20);
      add_cast_0 := resize(twdlXdin_14_re_signed, 20);
      Radix22ButterflyG1_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(twdlXdin_10_re_signed, 20);
      sub_cast_0 := resize(twdlXdin_14_re_signed, 20);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_1 := resize(twdlXdin_10_im_signed, 20);
      add_cast_2 := resize(twdlXdin_14_im_signed, 20);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(twdlXdin_10_im_signed, 20);
      sub_cast_2 := resize(twdlXdin_14_im_signed, 20);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= sub_cast_1 - sub_cast_2;
    END IF;
    dout_11_re_tmp <= Radix22ButterflyG1_NF_btf1_re_reg(18 DOWNTO 0);
    dout_11_im_tmp <= Radix22ButterflyG1_NF_btf1_im_reg(18 DOWNTO 0);
    dout_12_re_tmp <= Radix22ButterflyG1_NF_btf2_re_reg(18 DOWNTO 0);
    dout_12_im_tmp <= Radix22ButterflyG1_NF_btf2_im_reg(18 DOWNTO 0);
