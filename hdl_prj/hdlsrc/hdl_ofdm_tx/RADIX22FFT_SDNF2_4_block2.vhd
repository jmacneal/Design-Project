...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block2 IS
  ...
  -- Signals
  SIGNAL dout_7_re_signed                 : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din1_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_7_im_signed                 : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din1_im                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_15_re_signed                : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL din2_re                          : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_15_im_signed                : signed(18 DOWNTO 0);  -- sfix19_En13
  ...
  SIGNAL dout_7_re_tmp                    : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_7_im_tmp                    : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_8_re_tmp                    : signed(19 DOWNTO 0);  -- sfix20_En13
  SIGNAL dout_8_im_tmp                    : signed(19 DOWNTO 0);  -- sfix20_En13

BEGIN
  dout_7_re_signed <= signed(dout_7_re);

  din1_re <= resize(dout_7_re_signed, 20);

  dout_7_im_signed <= signed(dout_7_im);

  din1_im <= resize(dout_7_im_signed, 20);

  dout_15_re_signed <= signed(dout_15_re);

  din2_re <= resize(dout_15_re_signed, 20);

  dout_15_im_signed <= signed(dout_15_im);

  din2_im <= resize(dout_15_im_signed, 20);
  ...
  BEGIN
    ...
    END IF;
    dout_7_re_tmp <= Radix22ButterflyG2_NF_btf1_re_reg(19 DOWNTO 0);
    dout_7_im_tmp <= Radix22ButterflyG2_NF_btf1_im_reg(19 DOWNTO 0);
    dout_8_re_tmp <= Radix22ButterflyG2_NF_btf2_re_reg(19 DOWNTO 0);
    dout_8_im_tmp <= Radix22ButterflyG2_NF_btf2_im_reg(19 DOWNTO 0);
