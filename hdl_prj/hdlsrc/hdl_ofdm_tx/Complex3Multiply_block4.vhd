-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_ofdm_tx/Complex3Multiply_block4.vhd
...
ARCHITECTURE rtl OF Complex3Multiply_block4 IS
  ...
  SIGNAL twdlXdin_8_re_tmp                : signed(18 DOWNTO 0);  -- sfix19_En13
  SIGNAL twdlXdin_8_im_tmp                : signed(18 DOWNTO 0);  -- sfix19_En13
...
BEGIN
  ...
  twdlXdin_8_re_tmp <= multResFP_re(32 DOWNTO 14);

  twdlXdin_8_re <= std_logic_vector(twdlXdin_8_re_tmp);

  twdlXdin_8_im_tmp <= multResFP_im(32 DOWNTO 14);
