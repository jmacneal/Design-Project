-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/TWDLMULT_SDNF1_3_block1.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block1 IS
  ...
  -- Signals
  SIGNAL dout_2_re_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_2_im_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_4_re_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_4_im_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_6_re_tmp                : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_6_im_tmp                : std_logic_vector(19 DOWNTO 0);  -- ufix20
...
BEGIN
  u_MUL3_2 : Complex3Multiply_block2
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_6_re => twdlXdin_6_re_tmp,  -- sfix20
              twdlXdin_6_im => twdlXdin_6_im_tmp,  -- sfix20
              twdlXdin2_vld => twdlXdin_5_vld
              );

  dout_2_re_signed <= signed(dout_2_re);

  din_re <= resize(dout_2_re_signed, 20);
  ...
  din_im <= resize(dout_2_im_signed, 20);
  ...
  din_re_1 <= resize(dout_4_re_signed, 20);
  ...
  din_im_1 <= resize(dout_4_im_signed, 20);
