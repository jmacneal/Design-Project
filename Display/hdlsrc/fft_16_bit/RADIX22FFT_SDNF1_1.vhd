...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1 IS
  ...
  -- Signals
  SIGNAL twdlXdin_1_re_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_1_im_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_9_re_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_9_im_signed             : signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL dout_1_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_1_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_2_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_2_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_1_re_signed, 19) + resize(twdlXdin_9_re_signed, 19);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_1_re_signed, 19) - resize(twdlXdin_9_re_signed, 19);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_1_im_signed, 19) + resize(twdlXdin_9_im_signed, 19);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_1_im_signed, 19) - resize(twdlXdin_9_im_signed, 19);
    END IF;
    dout_1_re_tmp <= Radix22ButterflyG1_NF_btf1_re_reg(17 DOWNTO 0);
    dout_1_im_tmp <= Radix22ButterflyG1_NF_btf1_im_reg(17 DOWNTO 0);
    dout_2_re_tmp <= Radix22ButterflyG1_NF_btf2_re_reg(17 DOWNTO 0);
    dout_2_im_tmp <= Radix22ButterflyG1_NF_btf2_im_reg(17 DOWNTO 0);
