-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/RADIX22FFT_SDNF1_3_block3.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_3_block3 IS
  ...
  -- Signals
  SIGNAL twdlXdin_9_re_signed             : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL twdlXdin_9_im_signed             : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL twdlXdin_11_re_signed            : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL twdlXdin_11_im_signed            : signed(19 DOWNTO 0);  -- sfix20
  ...
  SIGNAL dout_9_re_tmp                    : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL dout_9_im_tmp                    : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL dout_10_re_tmp                   : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL dout_10_im_tmp                   : signed(19 DOWNTO 0);  -- sfix20
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_9_re_signed, 21) + resize(twdlXdin_11_re_signed, 21);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_9_re_signed, 21) - resize(twdlXdin_11_re_signed, 21);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_9_im_signed, 21) + resize(twdlXdin_11_im_signed, 21);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_9_im_signed, 21) - resize(twdlXdin_11_im_signed, 21);
    END IF;
    dout_9_re_tmp <= Radix22ButterflyG1_NF_btf1_re_reg(19 DOWNTO 0);
    dout_9_im_tmp <= Radix22ButterflyG1_NF_btf1_im_reg(19 DOWNTO 0);
    dout_10_re_tmp <= Radix22ButterflyG1_NF_btf2_re_reg(19 DOWNTO 0);
    dout_10_im_tmp <= Radix22ButterflyG1_NF_btf2_im_reg(19 DOWNTO 0);
