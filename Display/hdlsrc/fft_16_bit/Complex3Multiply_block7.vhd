-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/Complex3Multiply_block7.vhd
...
ARCHITECTURE rtl OF Complex3Multiply_block7 IS
  ...
  SIGNAL twdlXdin_12_re_tmp               : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL twdlXdin_12_im_tmp               : signed(19 DOWNTO 0);  -- sfix20
...
BEGIN
  ...
  twdlXdin_12_re_tmp <= multResFP_re(34 DOWNTO 15);

  twdlXdin_12_re <= std_logic_vector(twdlXdin_12_re_tmp);

  twdlXdin_12_im_tmp <= multResFP_im(34 DOWNTO 15);
