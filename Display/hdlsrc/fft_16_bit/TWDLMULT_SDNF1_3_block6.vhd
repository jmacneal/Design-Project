-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/TWDLMULT_SDNF1_3_block6.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block6 IS
  ...
  -- Signals
  SIGNAL dout_14_re_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_14_im_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_15_re_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_15_im_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin1_vld                    : std_logic;
  SIGNAL dout_16_re_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_16_im_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_16_re_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_16_im_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
...
BEGIN
  u_MUL3_1 : Complex3Multiply_block9
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_15_re => twdlXdin_15_re_tmp,  -- sfix20
              twdlXdin_15_im => twdlXdin_15_im_tmp,  -- sfix20
  ...
  u_MUL3_2 : Complex3Multiply_block10
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_16_re => twdlXdin_16_re_tmp,  -- sfix20
              twdlXdin_16_im => twdlXdin_16_im_tmp,  -- sfix20
              twdlXdin2_vld => twdlXdin_15_vld
              );

  dout_14_re_signed <= signed(dout_14_re);

  din_re <= resize(dout_14_re_signed, 20);
  ...
  din_im <= resize(dout_14_im_signed, 20);
  ...
  din_re_1 <= resize(dout_16_re_signed, 20);
  ...
  din_im_1 <= resize(dout_16_im_signed, 20);
