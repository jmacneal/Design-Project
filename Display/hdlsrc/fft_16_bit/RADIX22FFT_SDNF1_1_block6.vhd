-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/RADIX22FFT_SDNF1_1_block6.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block6 IS
  ...
  -- Signals
  SIGNAL twdlXdin_8_re_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_8_im_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_16_re_signed            : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_16_im_signed            : signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL dout_15_re_tmp                   : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_15_im_tmp                   : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_16_re_tmp                   : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_16_im_tmp                   : signed(17 DOWNTO 0);  -- sfix18
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_8_re_signed, 19) + resize(twdlXdin_16_re_signed, 19);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_8_re_signed, 19) - resize(twdlXdin_16_re_signed, 19);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_8_im_signed, 19) + resize(twdlXdin_16_im_signed, 19);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_8_im_signed, 19) - resize(twdlXdin_16_im_signed, 19);
    END IF;
    dout_15_re_tmp <= Radix22ButterflyG1_NF_btf1_re_reg(17 DOWNTO 0);
    dout_15_im_tmp <= Radix22ButterflyG1_NF_btf1_im_reg(17 DOWNTO 0);
    dout_16_re_tmp <= Radix22ButterflyG1_NF_btf2_re_reg(17 DOWNTO 0);
    dout_16_im_tmp <= Radix22ButterflyG1_NF_btf2_im_reg(17 DOWNTO 0);
