...
ARCHITECTURE rtl OF Complex3Multiply IS
  ...
  SIGNAL twdlXdin_2_re_tmp                : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL twdlXdin_2_im_tmp                : signed(19 DOWNTO 0);  -- sfix20
...
BEGIN
  ...
  twdlXdin_2_re_tmp <= multResFP_re(34 DOWNTO 15);

  twdlXdin_2_re <= std_logic_vector(twdlXdin_2_re_tmp);

  twdlXdin_2_im_tmp <= multResFP_im(34 DOWNTO 15);
