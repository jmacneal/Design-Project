-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/TWDLMULT_SDNF1_3_block4.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block4 IS
  ...
  -- Signals
  SIGNAL dout_13_re_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_13_im_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_11_re_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_11_im_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin1_vld                    : std_logic;
  SIGNAL dout_15_re_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_15_im_signed                : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_12_re_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_12_im_tmp               : std_logic_vector(19 DOWNTO 0);  -- ufix20
...
BEGIN
  u_MUL3_1 : Complex3Multiply_block6
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_11_re => twdlXdin_11_re_tmp,  -- sfix20
              twdlXdin_11_im => twdlXdin_11_im_tmp,  -- sfix20
  ...
  u_MUL3_2 : Complex3Multiply_block7
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_12_re => twdlXdin_12_re_tmp,  -- sfix20
              twdlXdin_12_im => twdlXdin_12_im_tmp,  -- sfix20
              twdlXdin2_vld => twdlXdin_11_vld
              );

  dout_13_re_signed <= signed(dout_13_re);

  din_re <= resize(dout_13_re_signed, 20);
  ...
  din_im <= resize(dout_13_im_signed, 20);
  ...
  din_re_1 <= resize(dout_15_re_signed, 20);
  ...
  din_im_1 <= resize(dout_15_im_signed, 20);
