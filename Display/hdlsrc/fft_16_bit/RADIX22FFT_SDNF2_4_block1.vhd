-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/RADIX22FFT_SDNF2_4_block1.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_4_block1 IS
  ...
  -- Signals
  SIGNAL dout_5_re_signed                 : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL din1_re                          : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL dout_5_im_signed                 : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL din1_im                          : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL dout_7_re_signed                 : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL din2_re                          : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL dout_7_im_signed                 : signed(19 DOWNTO 0);  -- sfix20
  ...
  SIGNAL dout_5_re_tmp                    : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL dout_5_im_tmp                    : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL dout_6_re_tmp                    : signed(20 DOWNTO 0);  -- sfix21
  SIGNAL dout_6_im_tmp                    : signed(20 DOWNTO 0);  -- sfix21

BEGIN
  dout_5_re_signed <= signed(dout_5_re);

  din1_re <= resize(dout_5_re_signed, 21);

  dout_5_im_signed <= signed(dout_5_im);

  din1_im <= resize(dout_5_im_signed, 21);

  dout_7_re_signed <= signed(dout_7_re);

  din2_re <= resize(dout_7_re_signed, 21);

  dout_7_im_signed <= signed(dout_7_im);

  din2_im <= resize(dout_7_im_signed, 21);
  ...
  BEGIN
    ...
    END IF;
    dout_5_re_tmp <= Radix22ButterflyG2_NF_btf1_re_reg(20 DOWNTO 0);
    dout_5_im_tmp <= Radix22ButterflyG2_NF_btf1_im_reg(20 DOWNTO 0);
    dout_6_re_tmp <= Radix22ButterflyG2_NF_btf2_re_reg(20 DOWNTO 0);
    dout_6_im_tmp <= Radix22ButterflyG2_NF_btf2_im_reg(20 DOWNTO 0);
