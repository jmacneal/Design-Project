-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/RADIX22FFT_SDNF1_1_block2.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_1_block2 IS
  ...
  -- Signals
  SIGNAL twdlXdin_4_re_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_4_im_signed             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_12_re_signed            : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL twdlXdin_12_im_signed            : signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL dout_7_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_7_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_8_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL dout_8_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_4_re_signed, 19) + resize(twdlXdin_12_re_signed, 19);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_4_re_signed, 19) - resize(twdlXdin_12_re_signed, 19);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_4_im_signed, 19) + resize(twdlXdin_12_im_signed, 19);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_4_im_signed, 19) - resize(twdlXdin_12_im_signed, 19);
    END IF;
    dout_7_re_tmp <= Radix22ButterflyG1_NF_btf1_re_reg(17 DOWNTO 0);
    dout_7_im_tmp <= Radix22ButterflyG1_NF_btf1_im_reg(17 DOWNTO 0);
    dout_8_re_tmp <= Radix22ButterflyG1_NF_btf2_re_reg(17 DOWNTO 0);
    dout_8_im_tmp <= Radix22ButterflyG1_NF_btf2_im_reg(17 DOWNTO 0);
