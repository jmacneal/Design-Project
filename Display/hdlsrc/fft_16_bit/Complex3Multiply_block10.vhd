-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/Complex3Multiply_block10.vhd
...
ARCHITECTURE rtl OF Complex3Multiply_block10 IS
  ...
  SIGNAL twdl_3_16_re_signed              : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL twdl_re_reg                      : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL twdl_3_16_im_signed              : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL twdlXdin_16_re_tmp               : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL twdlXdin_16_im_tmp               : signed(19 DOWNTO 0);  -- sfix20
...
BEGIN
  ...
  twdlXdin_16_re_tmp <= multResFP_re(34 DOWNTO 15);

  twdlXdin_16_re <= std_logic_vector(twdlXdin_16_re_tmp);

  twdlXdin_16_im_tmp <= multResFP_im(34 DOWNTO 15);
