-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/RADIX22FFT_SDNF2_2_block5.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF2_2_block5 IS
  ...
  -- Signals
  SIGNAL dout_6_re_signed                 : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL din1_re                          : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dout_6_im_signed                 : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL din1_im                          : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dout_14_re_signed                : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL din2_re                          : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dout_14_im_signed                : signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL dout_13_re_tmp                   : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dout_13_im_tmp                   : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dout_14_re_tmp                   : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dout_14_im_tmp                   : signed(18 DOWNTO 0);  -- sfix19

BEGIN
  dout_6_re_signed <= signed(dout_6_re);

  din1_re <= resize(dout_6_re_signed, 19);

  dout_6_im_signed <= signed(dout_6_im);

  din1_im <= resize(dout_6_im_signed, 19);

  dout_14_re_signed <= signed(dout_14_re);

  din2_re <= resize(dout_14_re_signed, 19);

  dout_14_im_signed <= signed(dout_14_im);

  din2_im <= resize(dout_14_im_signed, 19);
  ...
  BEGIN
    ...
    END IF;
    dout_13_re_tmp <= Radix22ButterflyG2_NF_btf1_re_reg(18 DOWNTO 0);
    dout_13_im_tmp <= Radix22ButterflyG2_NF_btf1_im_reg(18 DOWNTO 0);
    dout_14_re_tmp <= Radix22ButterflyG2_NF_btf2_re_reg(18 DOWNTO 0);
    dout_14_im_tmp <= Radix22ButterflyG2_NF_btf2_im_reg(18 DOWNTO 0);
