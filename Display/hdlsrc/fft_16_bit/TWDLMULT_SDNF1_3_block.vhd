-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/fft_16_bit/TWDLMULT_SDNF1_3_block.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block IS
  ...
  -- Signals
  SIGNAL dout_5_re_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_5_im_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_3_re_tmp                : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_3_im_tmp                : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin1_vld                    : std_logic;
  SIGNAL dout_7_re_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL dout_7_im_signed                 : signed(18 DOWNTO 0);  -- sfix19
  ...
  SIGNAL twdlXdin_4_re_tmp                : std_logic_vector(19 DOWNTO 0);  -- ufix20
  SIGNAL twdlXdin_4_im_tmp                : std_logic_vector(19 DOWNTO 0);  -- ufix20
...
BEGIN
  u_MUL3_1 : Complex3Multiply_block
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_3_re => twdlXdin_3_re_tmp,  -- sfix20
              twdlXdin_3_im => twdlXdin_3_im_tmp,  -- sfix20
  ...
  u_MUL3_2 : Complex3Multiply_block1
    PORT MAP( clk => clk,
              ...
              softReset => softReset,
              twdlXdin_4_re => twdlXdin_4_re_tmp,  -- sfix20
              twdlXdin_4_im => twdlXdin_4_im_tmp,  -- sfix20
              twdlXdin2_vld => twdlXdin_3_vld
              );

  dout_5_re_signed <= signed(dout_5_re);

  din_re <= resize(dout_5_re_signed, 20);
  ...
  din_im <= resize(dout_5_im_signed, 20);
  ...
  din_re_1 <= resize(dout_7_re_signed, 20);
  ...
  din_im_1 <= resize(dout_7_im_signed, 20);
