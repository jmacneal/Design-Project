-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/RADIX22FFT_SDNF2_2.vhd
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_din_vld_dly, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       dout_9_re_signed, dout_9_im_signed, dout_1_vld, rotate_1)
  ...
  BEGIN
    ...
    IF rotate_1 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_1_re_signed, 18) + resize(dout_9_im_signed, 18);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_1_re_signed, 18) - resize(dout_9_im_signed, 18);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_1_im_signed, 18) + resize(dout_9_re_signed, 18);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_1_im_signed, 18) - resize(dout_9_re_signed, 18);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_1_re_signed, 18) + resize(dout_9_re_signed, 18);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_1_re_signed, 18) - resize(dout_9_re_signed, 18);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_1_im_signed, 18) + resize(dout_9_im_signed, 18);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_1_im_signed, 18) - resize(dout_9_im_signed, 18);
    END IF;
