-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/RADIX22FFT_SDNF1_1_block6.vhd
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_8_re_signed, 18) + resize(twdlXdin_16_re_signed, 18);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_8_re_signed, 18) - resize(twdlXdin_16_re_signed, 18);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_8_im_signed, 18) + resize(twdlXdin_16_im_signed, 18);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_8_im_signed, 18) - resize(twdlXdin_16_im_signed, 18);
    END IF;
