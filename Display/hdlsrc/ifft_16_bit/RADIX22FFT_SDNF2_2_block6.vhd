-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/RADIX22FFT_SDNF2_2_block6.vhd
  ...
  BEGIN
    ...
    IF rotate_15 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_8_re_signed, 18) + resize(dout_16_im_signed, 18);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_8_re_signed, 18) - resize(dout_16_im_signed, 18);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_8_im_signed, 18) + resize(dout_16_re_signed, 18);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_8_im_signed, 18) - resize(dout_16_re_signed, 18);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_8_re_signed, 18) + resize(dout_16_re_signed, 18);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_8_re_signed, 18) - resize(dout_16_re_signed, 18);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_8_im_signed, 18) + resize(dout_16_im_signed, 18);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_8_im_signed, 18) - resize(dout_16_im_signed, 18);
    END IF;
