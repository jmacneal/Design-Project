-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/RADIX22FFT_SDNF1_3_block2.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_3_block2 IS
  ...
  -- Signals
  SIGNAL twdlXdin_6_re_signed             : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL twdlXdin_6_im_signed             : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL twdlXdin_8_re_signed             : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL twdlXdin_8_im_signed             : signed(16 DOWNTO 0);  -- sfix17
...
BEGIN
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      Radix22ButterflyG1_NF_btf1_re_reg_next <= resize(twdlXdin_6_re_signed, 18) + resize(twdlXdin_8_re_signed, 18);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= resize(twdlXdin_6_re_signed, 18) - resize(twdlXdin_8_re_signed, 18);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= resize(twdlXdin_6_im_signed, 18) + resize(twdlXdin_8_im_signed, 18);
      Radix22ButterflyG1_NF_btf2_im_reg_next <= resize(twdlXdin_6_im_signed, 18) - resize(twdlXdin_8_im_signed, 18);
    END IF;
