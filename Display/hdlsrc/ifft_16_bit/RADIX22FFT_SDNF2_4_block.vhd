  ...
  BEGIN
    ...
    IF rotate_3 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_2_re_signed, 18) + resize(dout_4_im_signed, 18);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_2_re_signed, 18) - resize(dout_4_im_signed, 18);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_2_im_signed, 18) + resize(dout_4_re_signed, 18);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_2_im_signed, 18) - resize(dout_4_re_signed, 18);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_2_re_signed, 18) + resize(dout_4_re_signed, 18);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_2_re_signed, 18) - resize(dout_4_re_signed, 18);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_2_im_signed, 18) + resize(dout_4_im_signed, 18);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_2_im_signed, 18) - resize(dout_4_im_signed, 18);
    END IF;
