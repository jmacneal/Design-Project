-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/Complex3Multiply_block9.vhd
...
ARCHITECTURE rtl OF Complex3Multiply_block9 IS
  ...
  SIGNAL twdlXdin_15_re_tmp               : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL twdlXdin_15_im_tmp               : signed(16 DOWNTO 0);  -- sfix17
...
BEGIN
  ...
  twdlXdin_15_re_tmp <= multResFP_re(31 DOWNTO 15);

  twdlXdin_15_re <= std_logic_vector(twdlXdin_15_re_tmp);

  twdlXdin_15_im_tmp <= multResFP_im(31 DOWNTO 15);
