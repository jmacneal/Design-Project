-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/Complex3Multiply_block8.vhd
...
ARCHITECTURE rtl OF Complex3Multiply_block8 IS
  ...
  SIGNAL twdlXdin_14_re_tmp               : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL twdlXdin_14_im_tmp               : signed(16 DOWNTO 0);  -- sfix17
...
BEGIN
  ...
  twdlXdin_14_re_tmp <= multResFP_re(31 DOWNTO 15);

  twdlXdin_14_re <= std_logic_vector(twdlXdin_14_re_tmp);

  twdlXdin_14_im_tmp <= multResFP_im(31 DOWNTO 15);
