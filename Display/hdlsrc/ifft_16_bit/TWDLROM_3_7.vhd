-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/ifft_16_bit/TWDLROM_3_7.vhd
...
-- 
-- Module: TWDLROM_3_7
-- Source Path: ifft_16_bit/IFFT HDL Optimized/TWDLROM_3_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF TWDLROM_3_7 IS
  ...
  SIGNAL twdl_3_7_re_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL twdl_3_7_im_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En15
