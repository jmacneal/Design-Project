-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/OFDM_transmitter/Complex3Multiply_block10.vhd
...
ARCHITECTURE rtl OF Complex3Multiply_block10 IS
  ...
  SIGNAL twdlXdin_16_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL twdlXdin_16_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En13
...
BEGIN
  ...
  twdlXdin_16_re_tmp <= multResFP_re(29 DOWNTO 14);

  twdlXdin_16_re <= std_logic_vector(twdlXdin_16_re_tmp);

  twdlXdin_16_im_tmp <= multResFP_im(29 DOWNTO 14);
