...
ARCHITECTURE rtl OF Complex3Multiply_block3 IS
  ...
  SIGNAL twdlXdin_7_re_tmp                : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL twdlXdin_7_im_tmp                : signed(15 DOWNTO 0);  -- sfix16_En13
...
BEGIN
  ...
  twdlXdin_7_re_tmp <= multResFP_re(29 DOWNTO 14);

  twdlXdin_7_re <= std_logic_vector(twdlXdin_7_re_tmp);

  twdlXdin_7_im_tmp <= multResFP_im(29 DOWNTO 14);
